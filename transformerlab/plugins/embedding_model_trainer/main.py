...
def train_embedding_model():
    ...
    try:
        json_data = {"description": f"An embedding model trained and generated by Transformer Lab based on {tlab_trainer.params.embedding_model}"}
        generate_model_json(final_model_name, tlab_trainer.params.get("embedding_model_architecture", "BertModel"), )
