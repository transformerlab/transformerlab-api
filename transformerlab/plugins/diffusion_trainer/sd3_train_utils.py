...
def verify_sdxl_training_args(args: argparse.Namespace, supportTextEncoderCaching: bool = True):
    ...
    assert not hasattr(args, "weighted_captions") or not args.weighted_captions, (
...
def sample_image_inference(
    ...
    with accelerator.autocast(), torch.no_grad():
        ...
        latents = do_sample(
            height, width, seed, cond, neg_cond, mmdit, sample_steps, scale, vae.dtype, accelerator.device
        )
