...
class SdxlTextEncodingStrategy(TextEncodingStrategy):
    ...
    def _get_hidden_states_sdxl(
        ...
        pool2 = self._pool_workaround(
            unwrapped_text_encoder2, enc_out["last_hidden_state"], input_ids2, tokenizer2.eos_token_id
        )
...
class SdxlTextEncoderOutputsCachingStrategy(TextEncoderOutputsCachingStrategy):
    ...
    def get_outputs_npz_path(self, image_abs_path: str) -> str:
        return (
            ...
            + SdxlTextEncoderOutputsCachingStrategy.SDXL_TEXT_ENCODER_OUTPUTS_NPZ_SUFFIX
        )
