...
output_model_name = f"mlx-{model_id}-{conversion_time}"
...
if (export_process.returncode == 0):
    model_description = [{
        "model_id": f"TransformerLab-mlx/{output_model_name}",
        "model_filename": output_model_name,
        "name" : f"{model_id} - MLX {args.quant_bits}bit",
        "local_model": True,
        "json_data" : {
            "uniqueID": f"TransformerLab-mlx/{output_model_name}",
            "name": f"MLX",
